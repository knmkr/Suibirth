...
function checkEndanger() {
	connection.query("SET @poly=?", 'Polygon((32.892764 -117.247124,32.869446 -117.247339,32.870275 -117.217384,32.891935 -117.223907,32.892764 -117.247124))', function(err, result) {
		if (err) return;
